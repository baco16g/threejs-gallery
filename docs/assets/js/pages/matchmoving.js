...
var Background = function () {
	...
	_createClass(Background, [{
		...
		value: function loadTexture(callback) {
			var texture = new THREE.Texture(this.textureSrc);
		...
		value: function createMesh(texture) {
			return new THREE.Mesh(new THREE.BoxGeometry(100, 100, 100), new THREE.MeshPhongMaterial({
				map: texture
			}));
		}
	}, {
...
var MatchMoving = function () {

	//===================================================================
	// ◆ コンストラクタ
	// - canvasのセッティング
	//===================================================================
	function MatchMoving() {
		var _this = this;

		_classCallCheck(this, MatchMoving);
	...
	_createClass(MatchMoving, [{
		...
		value: function init(vsbg, fsbg, vspp, fspp) {
			...
			//-------------------------------------------------------------------
			{
				this.bg = new _background2.default(vsbg, fsbg, this.video);
...
(function () {
	var postProcessApp = new MatchMoving();
})();
